...
import { LayoutDashboard, Car, ClipboardList, Building2, MessageSquareQuote, HelpCircle, KeyRound, LogOut, Menu, X, Images } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: "/admin/galeri", label: "Galeri Armada", icon: Images },
