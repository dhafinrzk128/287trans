...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    <a
      ...
      className="wa-float btn-glow-whatsapp group fixed bottom-6 right-6 z-40 flex h-14 items-center justify-center rounded-full bg-emerald-500 px-[0.875rem] text-white shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:bg-emerald-600"
    >
