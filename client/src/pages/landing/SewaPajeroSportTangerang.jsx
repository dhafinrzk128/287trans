    ...
    <div>
      ...
      <section className="mx-auto max-w-4xl px-4 py-14 sm:px-6 lg:px-8">
        ...
        <Reveal delay={100} className="mt-10">
          ...
          <p className="mt-3 leading-relaxed text-slate-700">
            Kalau Pajero Sport belum pas dengan kebutuhan atau anggaran Anda, berikut tarif harian untuk
        ...
        <Reveal delay={240} className="mt-10 rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            ...
            {profile?.whatsapp && (
              <a
                href={buildWaLink(profile.whatsapp, pesanSewa("Halo, saya mau sewa Mitsubishi Pajero Sport di Tangerang."))}
                target="_blank"
